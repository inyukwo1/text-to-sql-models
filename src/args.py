...
def init_arg_parser():
    ...
    arg_parser.add_argument('--action_embed_size', default=300, type=int, help='size of word embeddings')
    arg_parser.add_argument('--type_embed_size', default=300, type=int, help='size of word embeddings')
